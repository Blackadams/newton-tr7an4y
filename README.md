...
> Be patient! In ~3 mins your app is live, at your [app url](http://newton-tr7an4y.newton.wiki/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: http://newton-tr7an4y.newton.wiki/
...
```
git clone git@github.com:Blackadams/newton-tr7an4y.git
```
...
- [**Flask** quickstart guide](https://github.com/Blackadams/flask-quickstart)


## Questions

- How was this built? [All code is here](https://newton.wiki/)
